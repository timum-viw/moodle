...
/**
 * Strings for component 'block_coursefeedback', language 'de', branch 'MOODLE_31_STABLE'
 *
...
$string['adminpage_html_activefeedbackb'] = 'Wählen Sie einen Fragesatz. Dieser wird im Block "Kursfeedback" zur Evaluation bereit gestellt.<br /> Die verfügbaren Fragesätze können Sie unter "Umfragen erstellen/bearbeiten" ändern.';
$string['adminpage_html_allowhidinga'] = 'Verstecken erlauben';
$string['adminpage_html_allowhidingb'] = 'Wenn aktiviert, können Trainer/innen die Sichtbarkeit des Blockes bearbeiten.';
...
$string['coursefeedback:addinstance'] = 'Diesen Block zur Kursseite hinzufügen';
...
$string['coursefeedback:managefeedbacks'] = 'Globale Einstellungen des Kursfeedbacks bearbeiten';
...
$string['eventevaluated'] = 'Kurs ausgewertet';
$string['eventviewed'] = 'Ergebnisse angezeigt';
$string['form_area_questiontext'] = 'Text bearbeiten';
$string['form_header_confirm'] = 'Bestätigung erforderlich';
$string['form_header_deleteanswers'] = 'Nutzerantworten löschen';
...
$string['form_html_deleteanswerstext'] = 'Das Bearbeiten des Fragesatzes ist z.Z. nicht möglich, da bereits Nutzerantworten vorliegen. Sie können die Antworten löschen oder den Fragesatz kopieren.';
$string['form_html_deleteanswerswarning'] = 'Beim Löschen der Nutzerantworten gehen diese Daten unwiederbringlich verloren. <br/>Sie sollten sich sicher sein, diese Daten nicht mehr zu benötigen.';
...
$string['form_select_confirmyesno'] = 'Wirklich löschen?';
$string['form_select_deleteanswers'] = 'Butzerantworten löschen?';
...
$string['page_html_answersdeleted'] = 'Die Nutzerantworten wurden gelöscht.';
...
$string['perm_html_danswerslink'] = 'Um eine neue Umfrage mit den gleichen Fragen zu starten, können Sie die <a href="admin.php?fid={$a}&mode=feedback&action=new">Umfrage kopieren</a> oder die <a href="admin.php?fid={$a}&mode=feedback&action=danswers">Nutzerantworten löschen</a>.';
...
$string['table_html_undefinedlang'] = 'Übersetzung fehlt. Sprache \'{$a}\' nicht verfügbar.';
