...
/**
 * Strings for component 'grouptool', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   grouptool
...
$string['exceeduserqueuelimit'] = 'Maximale Anzahl der Wartelistenplätze des Nutzers üerschritten!';
$string['exceeduserreglimit'] = 'Maximale Anzahl an Anmeldungen des Nutzers überschritten!';
...
$string['notenoughregs'] = 'Minimale Anzahl an Anmeldungen des Nutzers noch nicht erreicht!';
...
$string['queuesizeerror'] = 'Wartelistenplatzbeschränkungen müssen ganzzahlig und positive sein (>= 1)';
...
$string['regpresent'] = 'Nutzer ist bereits {$a}';
