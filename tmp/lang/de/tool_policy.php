...
/**
 * Strings for component 'tool_policy', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   tool_policy
...
$string['acceptanceacknowledgement'] = 'Ich bestätige, dass die Einwilligung zu diesen Richtlinien eingeholt wurde und ich im Namen des Nutzers dies bestätigen darf.';
...
$string['acceptancestatusaccepted'] = 'Akzeptiert';
$string['acceptancestatusacceptedbehalf'] = 'Im Namen eines Nutzers akzeptiert';
$string['acceptancestatusdeclined'] = 'Abgewiesen';
$string['acceptancestatusdeclinedbehalf'] = 'Im Namen eines Nutzers abgewiesen';
$string['acceptancestatusoverall'] = 'Insgesamt';
$string['acceptancestatuspartial'] = 'Teilweise akzeptiert';
...
$string['cachedef_policy_optional'] = 'Cache für optionale/verpflichtende Kennzeichen für Richtlinienversionen';
...
$string['declineacknowledgement'] = 'Ich bestätige eine Anfrage zum Zurückweisen der Bestätigung im Namen des/der obigen Nutzer bekommen zu haben.';
$string['declinethepolicy'] = 'Nutzerzustimmung zurückweisen';
...
$string['filterstatusdeclined'] = 'Status: abgewiesen';
...
$string['iagreetothepolicy'] = 'Zustimmung abgeben';
$string['idontagree'] = 'Nein Danke. Ich lehne {$a} ab';
$string['inactivate'] = 'Status auf "inaktiv" setzen';
$string['inactivating'] = 'Richtlinie auf "inaktiv" setzen';
$string['inactivatingconfirm'] = '<p>Sie sind dabei die Richtlinie <em>\'{$a->name}\'</em> Version <em>\'{$a->revision}\'</em> inaktiv zu setzen.</p>';
...
$string['listactivepolicies'] = 'Liste von aktiven Policies';
...
$string['mustagreetocontinue'] = 'Sie müssen alle Teilen der Richtlinie bestätigen, um fortzufahren.';
...
$string['privacy:metadata:acceptances:lang'] = 'Sprache als Zustimmung gegeben wurde';
...
$string['privacy:metadata:acceptances:policyversionid'] = 'Version der Richtlinie, der zugestimmt wurde';
$string['privacy:metadata:acceptances:status'] = 'Status der Zustimmung';
$string['privacy:metadata:acceptances:timecreated'] = 'Zeitpunkt zu dem Zustimmung gegeben wurde';
$string['privacy:metadata:acceptances:timemodified'] = 'Zeitpunkt zu dem Zustimmung durch Nutzer geändert wurde';
$string['privacy:metadata:acceptances:userid'] = 'Nutzer, der Richtlinie zugestimmt hat';
$string['privacy:metadata:acceptances:usermodified'] = 'Nutzer, falls er im Namen eines anderen zugestimmt hat';
...
$string['privacy:metadata:versions'] = 'Richtlinieninformation';
$string['privacy:metadata:versions:archived'] = 'Richtlinienstatus (aktiv oder nicht aktiv)';
$string['privacy:metadata:versions:audience'] = 'Welche Nutzergruppe muss ihre Zustimmung geben';
...
$string['responseby'] = 'Antwortender';
...
$string['selectusersforconsent'] = 'Nutzer auswählen für den Bestätigung  gegeben werden soll.';
...
$string['statusformtitleaccept'] = 'Richtinie akzeptieren';
$string['statusformtitledecline'] = 'Richtlinie ablehnen';
$string['statusformtitlerevoke'] = 'Richtlinie widerrufeb';
...
$string['useracceptanceactionaccept'] = 'Akzeptieren';
$string['useracceptanceactionacceptone'] = '{$a} akzeptieren';
...
$string['useracceptanceactionrevokeall'] = 'Bestätigung der Richtlinien wiederrufen';
