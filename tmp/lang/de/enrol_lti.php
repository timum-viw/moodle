...
/**
 * Strings for component 'enrol_lti', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   enrol_lti
...
$string['incorrecttoken'] = 'Das Token war falsch. Überprüfen Sie die URL und versuchen Sie es erneut oder kontaktieren Sie den Administrator dieses Tools.';
...
$string['lti:unenrol'] = 'Nutzer/innen aus dem Kurs abmelden';
...
$string['maxenrolledreached'] = 'Die Höchstzahl der zugelassenenen Nutzer wurde erreicht.';
...
$string['membersyncmodeenrolandunenrol'] = 'Neue Mitglieder einschreiben und fehlende austragen';
$string['membersyncmodeenrolnew'] = 'Neue Nutzer/innen einschreiben';
$string['membersyncmode_help'] = 'Festlegung ob Remote-Nutzer in diesem Kurs ein und/oder ausgeschrieben werden sollen.';
...
$string['pluginname_desc'] = 'Das Plugin für die Bereitstellung von Zugriffen durch externe Nutzer ermöglicht Nutzern anderer Systeme  auf einen Kurs oder eine Aktivität zuzugreifen. Sie benötigen dazu lediglich einen Link. Das LTI Authentifizierungsplugin muss aktiv sein.';
...
$string['privacy:metadata:enrol_lti_users:timecreated'] = 'Datum an dem ein Nutzer eingeschrieben wurde';
...
$string['roleinstructor_help'] = 'Die Rolle, die in diesem Tool dem Lehrer, der von einem externen System zugreift, zugewiesen ist.';
...
$string['userdefaultvalues'] = 'Standardmäßige Nutzerwerte';
