...
/**
 * Strings for component 'dialogue', language 'de', branch 'MOODLE_34_STABLE'
 *
 * @package   dialogue
...
$string['cachedef_params'] = 'Parameter - Benutzeroberfläche';
...
$string['configmaxattachments'] = 'Standardmässige Maximalzahl erlaubter Anhänge pro Post.';
$string['configmaxbytes'] = 'Standardmässige Maximalzahl für alle Anhänge auf dieser Moodle-Site (abhängig von Kursbeschränkungen und weiteren lokalen Einstellungen)';
$string['configtrackunread'] = 'Zeige ungelesene Nachrichten auf der Hompeage des Kurses';
...
$string['deletereply'] = 'lösche Antwort';
...
$string['dialogue:bulkopenruleeditany'] = 'Gestattet Nutzer/in, eine beliebige Regel zu bearbeiten, nützlich für Administrator/innen etc.';
...
$string['dialogue:replyany'] = 'Antwort an beliebige';
$string['dialogue:viewany'] = 'Anzeigen alle';
$string['dialogue:viewbyrole'] = 'Zeige die Liste der Konversationen nach Rolle (experimentell)';
...
$string['includefuturemembers'] = 'Zukünftige Mitglieder mit-einschliessen';
...
$string['maxattachments'] = 'Maximale Anzahl Anhänge';
