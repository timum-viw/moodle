...
/**
 * Strings for component 'lightboxgallery', language 'de', branch 'MOODLE_36_STABLE'
 *
...
$string['configimagelifetimedesc'] = 'Zeitdauer (in Sekunden), während der die Bilder im Browsercache gespeichert bleiben.';
...
$string['eventgallerycommentcreated'] = 'Kommentar erstellt';
$string['eventgallerysearched'] = 'Bildergalerie durchsucht';
$string['eventimageupdated'] = 'Bild aktualisiert';
$string['eventviewed'] = 'Bildergalerie betrachtet';
...
$string['invalidlightboxgalleryid'] = 'Ungültige Lightbox Galerie ID';
...
$string['privacy:metadata:lightboxgallery_comments'] = 'Informationen zu Kommentaren in einer bestimmten Lightbox-Galerie';
$string['privacy:metadata:lightboxgallery_comments:commenttext'] = 'Der Textinhalt des Kommentars.';
$string['privacy:metadata:lightboxgallery_comments:gallery'] = 'Die ID der Lightbox-Galerie, die von einer Person kommentiert wurde.';
$string['privacy:metadata:lightboxgallery_comments:timemodified'] = 'Die Zeit, zu der der Kommentar zur Lightbox-Galerie geändert wurde.';
$string['privacy:metadata:lightboxgallery_comments:userid'] = 'Die ID der Person, die den Kommentar abgegeben hat.';
$string['resizeto'] = 'Größe ändern auf';
$string['rsssubscribe'] = 'Galerie RSS Feed';
$string['saveimage'] = '{$a} sichern';
$string['screen'] = 'Vollbild';
$string['search:activity'] = 'Lightbox-Galerie - Information zur Aktivität';
...
$string['tagscurrent'] = 'Aktuelle Schlagwörter';
$string['tagsdisabled'] = 'Schlagwörter deaktiviert';
$string['tagsimport'] = 'Schlagwörter importieren';
$string['tagsimportconfirm'] = 'Möchten Sie wirklich Schlagwörter für alle Bilder in dieser Galerie importieren?';
$string['tagsimportfinish'] = 'Import von {$a->tags} Schlagwörter für {$a->images} Bilder beendet';
$string['tagsiptc'] = 'IPTC Schlagwörter';
$string['tagspopular'] = 'Beliebte Schlagwörter';
$string['tagsrelated'] = 'Ähnliche Schlagwörter';
