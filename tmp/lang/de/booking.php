...
/**
 * Strings for component 'booking', language 'de', branch 'MOODLE_35_STABLE'
 *
 * @package   booking
...
$string['bookingmanagererror'] = 'Der eingegebene Benutzername ist nicht zulässig. Entweder existiert der Benutzername nicht oder es gibt mehrer Nutzer/innen mit diesem Benutzernamen (Dies ist zum Beispiel möglich, wenn gleichzeitig MNet und lokale Authentifizierung eingeschaltet ist.)';
...
$string['placesavailable'] = 'verfügbare Platze: {$a->available} von {$a->maxanswers}';
...
$string['showhelpfullnavigationlinks_helt'] = 'Navigationslinks "Gehe zu \'Buchung vornehmen\'" und "Nach oben" anzeigen.';
