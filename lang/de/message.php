...
$string['addtofavourites'] = 'Markierung setzen';
...
$string['blockedusers'] = 'Geblockte Nutzer/innen';
$string['blocknoncontacts'] = 'Mitteilungen nur für Kontakte zulassen';
$string['blockuser'] = 'Person sperren';
$string['blockuserconfirm'] = 'Möchten Sie wirklich {$a} sperren?';
...
$string['eventmessagecontactunblocked'] = 'Kontakt freigegeben';
$string['eventmessagedeleted'] = 'Mitteilung gelöscht';
$string['eventmessagesent'] = 'Mitteilung gesendet';
$string['eventmessageuserblocked'] = 'Geblockte Nutzer/innen';
$string['eventmessageuserunblocked'] = 'Nicht geblockte Nutzer/innen';
...
$string['nofavourites'] = 'Keine Mitteilung als Favorit markiert';
$string['noframesjs'] = 'Barrierefreie Oberfläche';
$string['nogroupconversations'] = 'Keine Gruppenmitteilungen';
$string['nogroupmessages'] = 'Keine Gruppengespräche';
$string['noindividualconversations'] = 'Keine persönlichen Mitteilungen';
...
$string['privacy:metadata:core_favourites'] = 'Die Kommunikation wurde von der Person als Favorit markiert';
...
$string['privacy:metadata:message_users_blocked'] = 'Liste geblockter Nutzer/innen';
$string['privacy:metadata:message_users_blocked:blockeduserid'] = 'ID des geblockten Nutzers';
$string['privacy:metadata:message_users_blocked:timecreated'] = 'Zeitpunkt an dem Nutzer geblockt wurde';
$string['privacy:metadata:message_users_blocked:userid'] = 'ID des blockenden Nutzers';
...
$string['privacy:metadata:notifications:timecreated'] = 'Zeitpunkt des Mitteilungs-Versands';
...
$string['removefromfavourites'] = 'Markierung entfernen';
...
$string['unblock'] = 'Entsperren';
$string['unblockcontact'] = 'Kontakt aktivieren';
$string['unblockuser'] = 'Person entsperren';
$string['unblockuserconfirm'] = 'Möchten Sie {$a} wirklich freigeben?';
...
$string['you'] = 'Sie:';
$string['youhaveblockeduser'] = 'Sie haben diese Person in der Vergangenheit gesperrt';
