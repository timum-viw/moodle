...
/**
 * Strings for component 'moodleoverflow', language 'de', branch 'MOODLE_36_STABLE'
 *
...
$string['clicktosubscribe'] = 'Sie haben dieses Thema nicht abonniert. Klicken Sie um diese zu abonnieren.';
$string['clicktounsubscribe'] = 'Sie haben dieses Thema abonniert. Klicken Sie um diese abzubestellen.';
...
$string['configpreferteachersmark'] = 'Die als gelöst markierte Antwort von dem Kursverantwortlichen wird gegenüber der als hilfreich markierten Antwort des Fragestellers priorisiert.';
...
$string['configvotescalesolved'] = 'Höhe der Reputation, die eine Bewertung als "gelöst" für einen Beitrag gibt.';
...
$string['marknothelpful'] = 'Nicht hilfreich';
$string['marknotsolved'] = 'Nicht gelöst';
...
$string['marksolved'] = 'Als gelöst markieren';
...
$string['maxmailingtime'] = 'Maximale Anzahl der Stunden, nachdem neue Beiträge nicht mehr per Mail versendet werden';
...
$string['moodleoverflow:marksolved'] = 'Einen Beitrag als gelöst markieren';
...
$string['rateownpost'] = 'Sie können nicht Ihren eigenen Beitrag bewerten.';
...
$string['ratingpreference_help'] = 'Antworten können als hilfreich und gelöst markiert werden. Diese Option legt fest, welche der Markierungen als erste Antwort in der Diskussion angezeigt wird. Es gibt 2 Möglichkeiten:

* Hilfreich - Der vom Fragesteller als hilfreich markierter Beitrag  wird ganz oben angezeigt
* Gelöst - Der vom Kursverantwortlichen als gelöst markierter Beitrag  wird ganz oben angezeigt';
...
$string['solvedanswer'] = 'Dieser Beitrag wurde als gelöst markiert.';
...
$string['votescalesolved'] = 'Reputation: Gelöst';
