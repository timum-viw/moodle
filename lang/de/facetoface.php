...
/**
 * Strings for component 'facetoface', language 'de', branch 'MOODLE_35_STABLE'
 *
 * @package   facetoface
...
$string['allowoverbook_help'] = 'Wenn "Überbuchung erlauben" aktiviert ist, können sich Teilnehmer/innen für einen Präsenztermin anmelden, auch wenn dieser bereits ausgebucht ist.<br />
...
$string['alreadysignedup'] = 'Sie haben sich bereits für diesen Präsenztermin angemeldet.';
$string['answer'] = 'Einloggen';
$string['answercancel'] = 'Ausloggen';
$string['approvalreqd'] = 'Genehmigung erforderlich';
$string['approvalreqd_help'] = 'Wenn "Genehmigung erforderlich" aktiviert ist benötigen Teilnehmer/innen die Genehmigung ihres/ihrer Vorgesetzten, um an einer Präsenzveranstaltung teilnehmen zu dürfen.';
...
$string['attendeestablesummary'] = 'Personen, die an diesem Termin teilnehmen werden oder teilgenommen haben.';
...
$string['calendareventdescriptionbooking'] = 'Sie sind für diesen <a href="{$a}">Präsenztermin</a> angemeldet.';
$string['calendareventdescriptionsession'] = 'Sie haben diese <a href="{$a}">Präsenzveranstaltung</a> erstellt.';
...
$string['cancellationconfirm'] = 'Möchten Sie wirklich die Buchung dieses Termins stornieren?';
$string['cancellationinstrmngr'] = '# Benachrichtigung an Vorgesetzte/n';
$string['cancellationinstrmngr_help'] = 'Wenn "Benachrichtigung an Vorgesetzte/n senden" aktiviert ist, wird der Text im Feld "Benachrichtigung für Vorgesetzte/n" an eine/n Vorgesetzte/n gesendet, der darauf hinweist, dass sich ein/e Mitarbeiter/in für eine Präsenzveranstaltung angemeldet hat.';
...
Wenn eine Präsenzveranstaltung die Kapazität erreicht, werden die Sitzungsdetails nicht auf der Kursseite angezeigt. Die Details werden auf der Seite "Alle Veranstaltungen anzeigen" ausgegraut angezeigt und der Interessent kann sich nicht für die Veranstaltung anmelden.
&nbsp;';
...
$string['confirmationinstrmngr_help'] = 'Wenn "Benachrichtigung an Vorgesetzte/n senden" aktiviert ist, wird der Text im Feld "Benachrichtigung an Vorgesetzte/n" an einen Vorgesetzten gesendet, der darauf hinweist, dass sich ein Mitarbeiter für eine Präsenzveranstaltung angemeldet hat.';
...
$string['crontask'] = 'Wartungsarbeiten von Präsenzveranstaltungen';
...
$string['description_help'] = '**Beschreibung** ist die Kursbeschreibung, die angezeigt wird, wenn sich ein Interessent für eine Präsenzveranstaltung anmeldet.
...
$string['editingsession'] = 'Session in {$a} wird bearbeitet';
$string['editsession'] = 'Session bearbeiten';
...
$string['emailmanagercancellation_help'] = 'Wenn "Hinweis an Vorgesetzte senden" aktiviert ist, wird eine E-Mail an Vorgesetzte des/der Lernenden gesendet, in der diese/r darauf hingewiesen wird, dass die Buchung der Präsenzveranstaltung storniert wurde.';
$string['emailmanagerconfirmation'] = '# Hinweis an Vorgesetzte senden';
$string['emailmanagerconfirmation_help'] = 'Wenn "Hinweis an Vorgesetzte senden" aktiviert ist, wird eine Bestätigungs-E-Mail an Vorgesetzte des/der Lernenden gesendet, sobald er/sie sich für eine Präsenzveranstaltung anmeldet.';
$string['emailmanagerreminder'] = '# Hinweis an Vorgesetzte senden';
$string['emailmanagerreminder_help'] = 'Wenn "Hinweis an Vorgesetzte senden" aktiviert ist, wird einige Tage vor dem Beginn einer Präsenzveranstaltung eine Erinnerungs-E-Mail an Vorgesetzte des/der Lernenden gesendet.';
...
$string['error:addalreadysignedupattendee'] = '{$a} ist bereits für diese Präsenzveranstaltung angemeldet.';
...
$string['error:canttakeattendanceforunstartedsession'] = 'Sie können nicht an einer Sitzung teilnehmen, die noch nicht begonnen hat.';
...
$string['error:couldnotaddsession'] = 'Session konnte nicht hinzugefügt werden';
$string['error:couldnotaddtrainer'] = 'Der neue Präsenztrainer konnte nicht gespeichert werden.';
$string['error:couldnotcopysession'] = 'Session konnte nicht hinzugefügt werden';
$string['error:couldnotdeletefield'] = 'Nutzerdefiniertes Sessionfeld konnte nicht gelöscht werden';
$string['error:couldnotdeletenotice'] = 'Die Standortnotiz konnte nicht gelöscht werden';
$string['error:couldnotdeletesession'] = 'Session konnte nicht gelöscht werden';
$string['error:couldnotdeletetrainer'] = 'Ein Präsenztrainer konnte nicht gelöscht werden.';
...
$string['error:couldnotupdatef2frecord'] = 'Der Face-to-Face-Anmeldedatensatz in der Datenbank konnte nicht aktualisiert werden.';
$string['error:couldnotupdatefield'] = 'Benutzerdefiniertes Sitzungsfeld konnte nicht aktualisiert werden.';
...
$string['error:f2ffailedupdatestatus'] = 'Face-to-Face konnte den Status des/der Teilnehmer/in nicht aktualisieren.';
...
$string['error:incorrectcoursemodulesession'] = 'Face-to-Face-Sitzung des Kursmoduls war falsch.';
$string['error:incorrectfacetofaceid'] = 'Face-to-Face ID war falsch';
...
$string['error:mustspecifycoursemodulefacetoface'] = 'Ein Kursmodul oder eine Face-to-Face ID muss angegeben werden.';
...
$string['exportattendance'] = 'Teilnehmerstatus exportieren';
$string['exporttofile'] = 'Export als Datei';
$string['facetoface'] = 'Präsenz';
$string['facetoface:addattendees'] = 'Teilnehmer zu einem Präsenztermin hinzufügen';
$string['facetoface:addinstance'] = 'Instanz hinzufügen';
$string['facetofacebooking'] = 'Präsenzveranstaltungsbuchung';
...
$string['facetoface:viewemptyactivities'] = 'Leere Präsenzveranstaltungen anzeigen';
...
$string['guestsno'] = 'Es tut uns leid, aber Gäste ist es nicht möglich, sich in Präsenztermine einzuschreiben.';
...
$string['pluginadministration'] = 'Verwaltung von Präsenzveranstaltungen';
$string['pluginname'] = 'Präsenzveranstaltungen';
...
$string['previoussessionslist'] = 'Liste aller vergangenen Termine für diese Präsenzveranstaltung';
$string['printversionid'] = 'Druckversion: ohne Namen';
$string['printversionname'] = 'Druckversion: mit Namen';
$string['really'] = 'Wollen Sie wirklich alle Ergebnisse für diese Präsenzveranstaltung löschen?';
...
$string['reminderinstrmngr_help'] = 'Wenn **Benachrichtigung an Vorgesetzte/n** senden markiert ist, wird der Text im Feld **Benachrichtigung an Vorgesetzte/n** an den/die Vorgesetzte/n eines Teilnehmers gesendet, der/die sich für eine Präsenzveranstaltung angemeldet hat.';
...
Der Abschnitt **Genehmigungsanforderung** zeigt die an den/die Teilnehmer/in und seinen/ihren Vorgesetzten gesendeten Mitteilungen über den Genehmigungsprozess für die Teilnahme an dem Präsenztermin an.
...
**Nachricht:** ist der E-Mail-Text, mit dem dem/der Teilnehmer/in mitgeteilt wird, dass seine/ihr Antrag auf Teilnahme an dem Präsenztermin an seinen/ihren Vorgesetzten zur Genehmigung gesendet wurde.

**Hinweis für den/die Vorgesetzte/n:** ist der E-Mail-Text, der an den/die Vorgesetzte/n des/der Lernenden geschickt wird, um die Genehmigung zur Teilnahme an dem Präsenztermin zu erhalten.';
$string['requeststablesummary'] = 'Personen, die an diesem Termin teilnehmen möchten.';
...
$string['search:activity'] = 'Präsenzveranstaltungen';
...
$string['sessiondatetime'] = 'Datum/Uhrzeit des Präsenztermins';
$string['sessiondatetimeknown'] = 'Datum/Uhrzeit des Präsenztermins bekannt';
...
$string['sessionsdetailstablesummary'] = 'Vollständige Beschreibung der aktuellen Veranstaltung.';
$string['sessionsoncoursepage'] = 'Auf der Kursseite angezeigte Veranstaltungen';
$string['sessionsoncoursepage_help'] = 'Dies ist die Anzahl der Termine für jede Präsenzveranstaltung, die auf der Hauptseite des Kurses angezeigt wird.';
...
$string['shortname_help'] = '**Kurzname** ist die Beschreibung des Termins, die im Veranstaltungskalender erscheint, wenn **Zeige im Kalender** ausgewählt ist.';
$string['showbylocation'] = 'Nach Standort anzeigen';
$string['showoncalendar'] = 'Einstellungen der Kalenderanzeige';
$string['showoncalendar_help'] = 'Wenn **Website** ausgewählt ist, werden die Präsenztermine im Veranstaltungskalender als allgemeines Ereignis angezeigt. Alle Besucher/innen der Website können diese Termine sehen.

Wenn **Kurs** ausgewählt ist, werden alle Präsenztermine im Kurskalender und als Kursveranstaltung im Kalender auf Seitenebene angezeigt und sind für alle angemeldeten Benutzer/innen sichtbar.

Wenn **keine** ausgewählt ist, werden Präsenztermine nur als Benutzerereignisse im Kalender eines bestätigten Teilnehmers angezeigt, sofern die Option **Im Kalender des/der Benutzers/Benutzerin anzeigen** ausgewählt wurde.';
$string['signup'] = 'Anmeldung';
$string['signupfor'] = 'Anmelden für {$a}';
$string['signupforsession'] = 'Melden Sie sich für einen verfügbaren bevorstehenden Termin an.';
$string['signupforthissession'] = 'Für diesen Präsenztermin anmelden';
...
$string['suppressemail_help'] = 'Verwenden Sie diese Option, wenn Sie im Hintergrund Teilnehmer zu einem Präsenztermin hinzufügen/entfernen möchten. Wenn diese Option aktiviert ist, wird die übliche E-Mail-Bestätigung nicht an die ausgewählten Teilnehmer gesendet.';
...
Wenn Sie **mehrere E-Mail-Adressen** eingeben, trennen Sie jede Adresse mit einem Komma. Zum Beispiel: bob@example.com,joe@example.com';
$string['thirdpartywaitlist'] = 'Dritte über Termine mit Wartelisten benachrichtigen';
$string['thirdpartywaitlist_help'] = 'Wenn **Dritte über Termine mit Wartelisten benachrichtigen** ausgewählt ist, wird/werden der/die Dritte(n) benachrichtigt, wenn sich ein Teilnehmer für einen Präsenztermin mit Warteliste anmeldet.
Wenn **Dritte über Veranstaltungen mit Wartelisten benachrichtigen** nicht aktiviert ist werden Dritte nur benachrichtigt, wenn sich ein/e Teilnehmer/in für einen geplanten Präsenztermin anmeldet (oder seine/ihre Teilnahme storniert).';
$string['time'] = 'Uhrzeit';
$string['timecancelled'] = 'Uhrzeit abgesagt';
$string['timedue'] = 'Anmeldeschluss';
$string['timefinish'] = 'Ende';
$string['timefinish_help'] = 'Ende ist die Zeit, zu welcher der Präsenztermin endet.';
$string['timerequested'] = 'Gewünschte Uhrzeit';
$string['timesignedup'] = 'Uhrzeit der Anmeldung';
$string['timestart'] = 'Anfang';
$string['timestart_help'] = 'Anfang ist die Zeit, zu welcher der Präsenztermin beginnt.';
...
$string['upcomingsessionslist'] = 'Liste aller bevorstehenden Sitzungen für diese Präsenzveranstaltung';
$string['updaterequests'] = 'Änderungswünsche';
$string['upgradeprocessinggrades'] = 'Die Verarbeitung von Präsenzveranstaltungsnoten kann eine Weile dauern, wenn es viele Veranstaltungen gibt.';
$string['usercalentry'] = 'Eintrag im Kalender eines/r Teilnehmers/in anzeigen';
$string['usercalentry_help'] = 'Wenn diese Einstellung aktiviert ist, wird dem Kalender eines/einer Teilnehmers/in einer Präsenzveranstaltung ein Eintrag hinzugefügt. Wenn diese Option deaktiviert ist, wird verhindert, dass ein doppeltes Ereignis im Kalender eines/einer Veranstaltungsteilnehmers/in angezeigt wird, in dem die Einstellungen für die Kalenderanzeige auf Kurs oder Veranstaltungsort eingestellt sind.';
...
$string['userwillbewaitlisted'] = 'Diese Sitzung ist derzeit ausgebucht. Durch Anklicken der Schaltfläche "Anmelden" werden Sie auf die Warteliste des Termins gesetzt.';
$string['validation:needatleastonedate'] = 'Sie müssen mindestens ein Datum angeben oder die Warteliste für den Termin freigeben.';
...
Das **Veranstaltungsgebäude** wird auf der Anmeldungsseite, der Seite \'Alle Sitzungen anzeigen\' und in allen E-Mail-Benachrichtigungen angezeigt.';
$string['viewallsessions'] = 'Alle Termine ansehen';
...
$string['waitliststatus'] = 'Sie stehen auf der Warteliste für folgenden Präsenztermin';
$string['xhours'] = '{$a} Stunden';
$string['xminutes'] = '{$a} Minuten';
$string['youarebooked'] = 'Sie haben sich für folgenden Präsenztermin angemeldet';
