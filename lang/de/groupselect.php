...
/**
 * Strings for component 'groupselect', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   groupselect
...
$string['deleteemptygroups_help'] = 'Diese Option legt fest, dass die Gruppe automatisch gelöscht wird, sobald alle Teilnehmer/innen die Gruppe verlassen haben.';
...
$string['hidefullgroups_help'] = 'Wenn gesetzt, werden alle Gruppen, bei denen die maximale Anzahl an Mitgliedern erreicht wurde, von der Hauptansicht versteckt (ausgenommen Gruppen, die von Benutzern selbst angelegt wurden). Dies könnte nützlich sein, wenn diese Aktivität sehr viele Gruppen hat.';
