...
/**
 * Strings for component 'filter_poodll', language 'de', branch 'MOODLE_36_STABLE'
 *
...
$string['awssdkversion_desc'] = 'PoodLL Cloud Recording nutzt Amazon Web Services (AWS). Version 3.x wird unterstützt aber nicht mit PoodLL ausgeliefert. Version 2.x des AWS SDK läuft mit PHP 5.3 oder höher. Wenn Sie AWS SDK 3.x verwenden müssen, dann speichern Sie es in einen Ordner mit dem Namen aws-v3 in filter/poodll/3rdparty.';
