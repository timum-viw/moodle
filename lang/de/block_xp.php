...
/**
 * Strings for component 'block_xp', language 'de', branch 'MOODLE_36_STABLE'
 *
 * @package   block_xp
...
$string['admindefaultsettingsintro'] = 'Die folgenden Einstellungen werden als Standard verwendet, wenn der Block neu in einen Kurs eingefügt wird.';
...
$string['cheatguard'] = 'Schutz gegen den Betrug';
$string['clicktoselectcm'] = 'Klicken Sie, um eine Aktivität oder ein Material auszuwählen';
$string['cmselector'] = 'Kursmodul-Wähler';
$string['coefxp'] = 'Koeffizient des Algorithmus';
$string['colon'] = '{$a->a}: {$a->b}';
$string['configdescription'] = 'eine Beschreibung einfügen';
$string['configdescription_help'] = 'Eine Kurzbeschreibung, die im Block unterhalb des Studierendenlevels angezeigt wird. Die Studierenden haben die Möglichkeit, die Meldung wegzuklicken. In diesem Fall wird sie Ihnen nicht mehr angezeigt.';
$string['configheader'] = 'Einstellungen';
$string['configrecentactivity'] = 'Neue Belohnungen anzeigen';
$string['configrecentactivity_help'] = 'Wenn diese Option aktiviert wurde, zeigt der Block eine kurze Liste der letzten Aktivitäten, bei denen die Studierenden mit Punkten belohnt wurden.';
...
$string['enablecheatguard_help'] = 'Der Cheat Guard bietet einen einfachen kostengünstigen Mechanismus, um zu verhindern, dass Studierende das System missbrauchen, indem sie offensichtliche Techniken verwenden, wie zum Beispiel die endlose Aktualisierung derselben Seite oder die Wiederholung derselben Aktion immer und immer wieder.';
...
$string['enablexpgain'] = 'XP-Zuwachs aktivieren';
...
Hinweis: Mit Hilfe der Berechtigung \'block/xp:earnxp\' kann dies u.U. genauer gesteuert werden.';
...
$string['errornotalllevelsbadgesprovided'] = 'Nicht für alle Levels wurden Abzeichen bereitgestellt. Fehlend: {$a}';
$string['errorunknownevent'] = 'Fehler: unbekanntes Ereignis';
$string['errorunknownmodule'] = 'Fehler: unbekanntes Modul';
$string['errorxprequiredlowerthanpreviouslevel'] = 'Der erforderliche XP ist niedriger oder gleich zum vorherigen Level.';
$string['eventis'] = 'Das Ereignis ist {$a}';
$string['eventname'] = 'Eventbezeichnung';
$string['eventproperty'] = 'Event-Eigenschaft';
...
$string['ladderempty'] = 'Die Rangliste ist zur Zeit leer, versuchen Sie es später wieder!';
$string['level'] = 'Level';
$string['levelbadges'] = 'Levelabzeichen';
$string['levelbadgesformhelp'] = 'Benennen Sie die Dateien [level].[file extension], zum Beispiel: 1.png, 2.jpg, etc... Die empfohlene Bildgröße beträgt 100x100.';
$string['levelcount'] = 'Levelstufen';
$string['leveldesc'] = 'Levelbeschreibung';
$string['levels'] = 'Levels';
$string['levelswillbereset'] = 'Achtung! Beim Speichern dieses Formulars werden alle Levels für jeden neu berechnet.';
...
$string['maxactionspertime_help'] = 'Die maximale Anzahl der Aktionen, die während des Zeitrahmens für XP gegeben werden. Jede nachfolgende Aktion wird ignoriert.';
...
$string['promointro'] = 'Das Add-on für _Level up!_ das sein volles Potential entfalltet.';
...
$string['ranking_help'] = 'Der Rang ist die absolute Position des aktuellen Nutzers auf der Rangliste. Der relative Rang ist der Unterschied in XP zwischen dem Nutzer und seinen Nachbarn.';
...
$string['reallyresetdata'] = 'Möchten Sie wirklich alle Level und die Erfahrungspunkte für alle Personen in diesem Kurs zurücksetzen?';
$string['reallyresetgroupdata'] = 'Möchten Sie wirklich alle Level und die Erfahrungspunkte für alle Personen in dieser Gruppe zurücksetzen?';
...
$string['reverttopluginsdefaultsintro'] = 'Benutzen Sie die folgende Schaltfläche, wenn Sie auf die Standardeinstellungen des Plugins zurücksetzen wollen.';
...
$string['shortcode:xpladder'] = 'Einen Ausschnitt der Rangliste mit der aktuellen Position des Nutzers anzeigen.';
...
$string['timebetweensameactions_help'] = 'Die Mindestdauer in Sekunden, die zwischen zwei Aktionen liegen muß. Eine Aktion gilt als identisch wenn sie im gleichen Objekt und Kontext erfolgt. Beispiel: Das Lesen eines Forenbeitrags ist identisch mit dem wiederholten Lesen des gleichen Forenbeitrags.';
...
$string['when'] = 'Wann';
$string['wherearexpused'] = 'Wo werden Erfahrungspunkte benutzt?';
$string['wherearexpused_desc'] = 'Bei Einstellung \'In Kursen\' gelten die gewonnenen Erfahrungspunkte nur für den Kurs, in dem der Block eingefügt wurde. Bei Einstellung \'Für die ganze Website\', steigt ein Nutzer schneller im Rang auf als pro Kurs, da alle Erfahrung irgendwo innerhalb der Website verwendet wird.';
$string['whoops'] = 'Hoppla!';
$string['xp'] = 'Erfahrungspunkte';
$string['xp:addinstance'] = 'Block \'XP\' hinzufügen';
$string['xp:earnxp'] = 'Erfahrungspunkte verdienen';
$string['xpgaindisabled'] = 'XP-Zuwachs deaktivieren';
$string['xp:myaddinstance'] = 'Block meinem Dashboard hinzufügen';
$string['xprequired'] = 'XP notwendig';
