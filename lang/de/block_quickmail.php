...
/**
 * Strings for component 'block_quickmail', language 'de', branch 'MOODLE_35_STABLE'
 *
...
$string['addionalemail'] = 'E-Mails an externe E-Mail-Adressen zulassen';
$string['addionalemail_desc'] = 'Wenn diese Option aktiviert ist, werden Quickmail-E-Mails auch an externe E-Mail-Adressen gesendet, die in das Formular eingegeben werden.';
...
$string['download_auth_only'] = 'Nur berechtigte Nutzer/innen';
$string['download_open'] = 'Downloads öffnen';
